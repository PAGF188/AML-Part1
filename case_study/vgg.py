...
"""## PART1: Training/testing of both models in Fashion MNIST and comparison

### VGG-16 model
"""

def vgg16(train=False):
    # configuration
    ...
    # """This model needs a (224,224,3) tensor input, but Fashion MNIST images are (28,28). To solve this problem, resize the images to be (224,224), and then we extend (repeating) to 3 dimensions"""
    ...
    if train:
        ...
        # Save
        torch.save(model.state_dict(), os.path.join('./models','final_model_vgg_10epocs.pt'))
        print(hist)
